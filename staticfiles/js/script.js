function toggleSection(sectionId, buttonId) {
 ...
 document.addEventListener("DOMContentLoaded", function () {
    ...
    if (clearButton) {
        ...
        console.warn("Botón de limpiar no encontrado");
    }
});
...
function generarDocumento(tipo, contratoId) {
        ...
        if (!destinatario) {
            ...
            errorMensaje.innerText = "Seleccione un destinatario antes de generar el documento.";
        ...
        fetch(url)
            ...
            .then(data => {
                if (data.success) {
                    ...
                    errorMensaje.innerText = "Error en la petición: " + error;
                    errorMensaje.style.display = "block";
                }
            })
